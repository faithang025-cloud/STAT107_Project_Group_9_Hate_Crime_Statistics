...
broad_groups <- hateCrime_Final %>%
  mutate(category = case_when( # when category, place them into broad group
    # placing all races into race/ethicity
    ...
    # placing all religions into religion
    ...
    # Placing all sexuality-based victims into sexual orientation
    ...
    TRUE ~ "Other" #this places other targets/victims that don't fall into the "other" category
  ))
...
# filter observations of different races to a group called race_groups
