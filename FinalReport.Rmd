...
The three bar graphs (“top_3_simple_assault.png”, “top_3_intimidation.png”, “top_3_vandal.png”) rank states by the number of incidents for the three most common offense types: simple assault, intimidation, and destruction/damage/vandalism of property. We deliberately kept the state order identical across all three plots so that cross-offense comparisons are immediate and intuitive.
...
Some states with large populations (e.g., Michigan, Ohio) rank lower than expected, hinting at possible underreporting or weaker statutory incentives for local agencies to classify and submit incidents as hate crimes.
