...
- created 00_requirements.R and filled it with the libraries needed for the project
- Filled 01_funct_DataCleaning.R with functions to clean data and rename variables
- Made ggplot templates for various plots in 02_funct_Plots.R
