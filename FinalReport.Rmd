...
##"Which groups (racial, religious, gender, state etc...) are most frequently targeted, and what may have caused the increase or decrease of certain types of hate crime over the years?"
...
```
To deepen our understanding of hate crime patterns, we aimed to see how location shapes hate crimes. Examining location is critical because hate crimes are not randomly distributed across the US. They are may be more concentrated in some states because of differences in population size, demographic diversity, political environments etc. Identifying these geographic patterns helps policymakers and communities create prevention resources based on where they are most needed.

The West and South consistently report the highest case rates mostly because they have the most populous states (California, Texas, Florida, etc.). The Northeast and Midwest have lower totals, which could be due to having fewer states or smaller and less diverse areas. Despite these differences, all four regions have similar long-term trends: a peak in the late 1990s to early 2000s, a decline from 2008–2016, and an increase from around 2017–2018 to 2024. These patterns can help us determine how national level events such as political polarization, incidents that are popularized by social media, leadership changes, or, as mentioned before, simply improving the reporting mechanisms can have a powerful influence across the nation.

California, New York, New Jersey, Washington, and Massachusetts appear near the top in nearly every category which may reflect their large populations and maybe more established hate-crime reporting infrastructure. We also see that state by state there are differences even between the three categories. For instance, New Jersey has high intimidation numbers but much lower simple-assault counts. On the other hand, there are some states that show little relative variation across all offense types like Texas and Florida which indicate a more balanced distribution of hate-crime expressions.
...
data:  table_pv
X-squared = 8326.1, df = 24, p-value < 2.2e-16

This chi-square test examined whether the distribution of the four most common offense types (vandalism, intimidation, simple assault, and aggravated assault) differed across victim bias categories. From this we got that there is a statistically significant relationship between the victim's targeted group and the type of offense committed since p-value < 2.2e-16 which is far smaller than our significance level p = 0.05.

This tells us that the patterns for offenses are not random when considering different biases. Certain types of hate-motivated offenses occur more frequently against particular more targeted groups. Some victim groups may experience more intimidation incidents, while others face higher levels of physical assaults. The results suggest that these differences are meaningful and can be used to make policy decisions to protect the more vulnerable communities.


## Conclusion

The purpose of this research was to find hate crime patterns, examine deeper the bias motivation, offense type, location, and how things change over time. After conducting our analysis, it revealed that certain biases, especially ethnic motivations, were the largest share of hate crimes, consequently telling us they were most targeting. Within broader main biases, specific sub bias groups were disproportionately targeted like such as Anti-Gay (male), Anti-Black and African American and Anti-Jewish. We also observed that incident counts fluctuating across the years which may be due to broad social or political events. Through data visualizations and our chi-squared test, we were able to compare trends across states and biases and highlight how hate crime patterns change across demographically and geographically.

For continued research, we can see how social, economic, or political variables determine what triggers increases or decreases in hate crimes. We can also see what causes under reporting/increased reporting in different locations. All in all, this project shows the value of using statistics to uncover meaningful social justice trends to support policymakers and protect the community as a whole.

### Contributions Section

THE GitHub link:

{r} [Project](https://github.com/faithang025-cloud/STAT107_Project_Group_9_Hate_Crime_Statistics)
...
- Worked on Abstract, Introduction, Data, Data Cleaning, Visualization and Analysis, Chi-Squared Test, Conclusion, portion of FinalReport.Rmd.

Xuanwei Ding:
- Worked substantially on 12_Plots.Rmd, coding for questions 3, 4, 5, and 6 on 12_Plots.Rmd.
- Worked on the analysis of the top 3 hate crimes.
